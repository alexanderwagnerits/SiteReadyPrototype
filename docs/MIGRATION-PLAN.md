...
| **sevDesk Buchhaltungs-Plan** ✅ **EINGERICHTET 2026-05-16** — Monatsabo (17,43 EUR Aktion erste 3 Mo, danach 24,90 EUR regulaer). AT-Konformitaet aktiv: Kleinunternehmerregelung, SKRAT-Kontenrahmen, E/A-Rechnung, Pflicht-Footnote auf Rechnungen, Wagner-IT-Solutions-Stammdaten + Logo. Banking Erste Business via PSD2 verknuepft. Zweites Verrechnungskonto „Privat Konto" angelegt fuer Privateinlagen/-entnahmen (Buchungskonto 2820 default oder 9100 falls umgestellt). 2 wiederkehrende Rechnungen aktiv (CPG 490 EUR + Dr. Gehrer 100 EUR) ab 31.05.2026. **MiracleSync verschoben** auf Volumen-Trigger (~30-50 Subscriptions, dann Upgrade Buchhaltung Pro 10,47 EUR Aktion + REST-API). Bis dahin: manueller monatlicher Stripe-Sync — siehe `OPERATIONS.md` § 8.7. | abgeschlossen | Phase 0 | ✅ live, Detail in `PRODUCT.md` § 3.0 |
