...
- **Anwalts-Aktivierung im Ernstfall:** Datenpanne ist ein **Anwalts-Trigger** nach `LIVE-COMPLIANCE.md` § 18 — bei realer Panne sofort Anwalts-Beratung buchen (DSB-Verfahren-Begleitung, geschaetzt ~5h / €1.750). Vor Live-Schaltung: Selbstcheck Art. 34 Abs. 2 Pflichtinhalte gegen diese Vorlage (Pivot 2026-05-15 — kein Vorab-Anwalts-Audit).
