        ...
        {!loading&&tab==="arch-flows"&&(()=>{
          ...
          return(<div id="arch-flows-print">
            ...
            <div style={{background:T.bg,borderRadius:T.rSm,padding:"16px 18px",border:`1px solid ${T.bg3}`,marginBottom:16}}>
              ...
              {fphase("Phase 4 – Generierung","#8b5cf6",<>{fnode("⚙️","Wird erstellt","status: pending · ~30-60 Sek.","#8b5cf6")}{farrow}{fnode("🤖","Claude Sonnet","claude-sonnet-4-6","#8b5cf6")}{farrow}{fnode("🔧","Post-Processing","Nav · Footer · Meta · Schema.org","#8b5cf6")}{farrow}{fnode("🔬","Testphase","status: trial · 7 Tage","#8b5cf6")}</>)}
              {fphase("Phase 4b – Abo-Abschluss (innerhalb 7 Tage)","#16a34a",<>{fnode("💳","Plan waehlen","18 Euro/Mo oder 172.80 Euro/Jahr","#16a34a")}{farrow}{fnode("🔗","create-checkout","Stripe Subscription + Trial","#16a34a")}{farrow}{fnode("✅","Karte hinterlegt","keine Abbuchung bis Tag 8","#16a34a")}{farrow}{fnode("🌍","Live","invoice.paid → status: live","#16a34a")}</>)}
              ...
              {fphase("Phase 7a – Kein Abo nach 7 Tagen","#ef4444",<>{fnode("⏰","Trial abgelaufen","trial_expires_at ueberschritten","#ef4444")}{farrow}{fnode("🗑️","Auto-Loeschung","trial-cleanup.js · taeglich","#ef4444")}{farrow}{fnode("💀","Alles geloescht","User · Storage · Order","#ef4444")}</>)}
              {fphase("Phase 7b – Ende des Abos","#94a3b8",<>{fnode("❌","Kuendigung","Monatsabo: jederzeit · Jahresabo: nach 12 Mo","#94a3b8")}{farrow}{fnode("🚫","Offline","subscription.deleted → status: offline","#94a3b8")}{farrow}{fnode("🗑️","Daten loeschen","auf Wunsch","#94a3b8",true)}</>)}
