...
function Preview({d,compact}){const s=d.stil==="custom"?buildCustomStyle(d):(STYLES_MAP[d.stil]||STYLES_MAP.klassisch);const extraItems=d.extraLeistung?d.extraLeistung.split("\n").filter(l=>l.trim()):[];const allItems=[...(d.leistungen||[]),...extraItems];const hasContact=d.adresse||d.telefon||d.email;const px=compact?"20px":"28px";const adressFull=[d.adresse,[d.plz,d.ort].filter(Boolean).join(" ")].filter(Boolean).join(", ");const zeit=d.oeffnungszeiten==="custom"?d.oeffnungszeitenCustom:(OEFFNUNGSZEITEN.find(o=>o.value===d.oeffnungszeiten)?.label||"");return(<div style={{fontFamily:s.font,background:s.bg,color:s.text,minHeight:"100%",fontSize:"14px",lineHeight:1.65,overflowY:"auto",transition:"background 0.4s"}}><div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:`10px ${px}`,background:s.cardBg,borderBottom:`1px solid ${s.borderColor}`,position:"sticky",top:0,zIndex:10}}><div style={{fontWeight:700,fontSize:compact?"13px":"15px",color:s.primary}}>{d.firmenname||"Firmenname"}</div><div style={{display:"flex",gap:compact?"12px":"20px",fontSize:"12px",color:s.textMuted}}><span>Leistungen</span><span>Über uns</span><span style={{padding:"4px 12px",borderRadius:s.btnRadius||"20px",background:s.primary,color:"#fff",fontWeight:600,fontSize:"10px"}}>Kontakt</span></div></div><div style={{background:s.heroGradient,position:"relative",overflow:"hidden",padding:compact?"32px 20px 28px":"48px 28px 44px",color:"#fff"}}><div style={{position:"absolute",inset:0,background:s.heroOverlay}}/><div style={{position:"relative",zIndex:1,display:"flex",gap:"20px",alignItems:"center"}}><div style={{flex:1}}><div style={{display:"flex",flexWrap:"wrap",gap:"6px",marginBottom:"12px"}}>{d.notdienst&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>⚡ 24h Notdienst</div>}{d.meisterbetrieb&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>🏆 Meisterbetrieb</div>}{d.kostenvoranschlag&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>✓ Kostenloser KV</div>}{d.hausbesuche&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>🏠 Hausbesuche</div>}{d.terminvereinbarung&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>📅 Nur mit Termin</div>}{d.foerderungsberatung&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>💰 Förderungsberatung</div>}{d.lieferservice&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>🚚 Lieferservice</div>}{d.barrierefrei&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>♿ Barrierefrei</div>}{d.parkplaetze&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>🅿 Parkplätze</div>}{d.kassenvertrag&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>🏥 {d.kassenvertrag==="alle_kassen"?"Alle Kassen":d.kassenvertrag==="wahlarzt"?"Wahlarzt":d.kassenvertrag==="privat"?"Nur Privat":d.kassenvertrag.toUpperCase()}</div>}{d.erstgespraech_gratis&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>🤝 Erstgespräch gratis</div>}{d.online_beratung&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>💻 Online-Beratung</div>}{d.ratenzahlung&&<div style={{display:"inline-block",padding:"3px 10px",background:"rgba(255,255,255,0.18)",borderRadius:s.badgeRadius||"20px",fontSize:"10px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase"}}>📋 Ratenzahlung</div>}</div><h1 style={{fontSize:compact?"20px":"26px",fontWeight:700,margin:"0 0 8px",letterSpacing:"-0.025em",lineHeight:1.15}}>{d.firmenname||"Ihr Firmenname"}</h1><p style={{margin:"0 0 4px",opacity:0.85,fontSize:compact?"12px":"14px",fontWeight:500}}>{(d.branche==="sonstige"?d.brancheCustom:d.brancheLabel)||"Ihre Branche"}{d.einsatzgebiet?` \u00B7 ${d.einsatzgebiet}`:""}</p>{d.kurzbeschreibung&&<p style={{margin:"12px 0 0",opacity:0.75,fontSize:compact?"11px":"13px",lineHeight:1.55}}>{d.kurzbeschreibung}</p>}{d.telefon&&<div style={{marginTop:"16px",display:"inline-flex",alignItems:"center",gap:"8px",background:"rgba(255,255,255,0.15)",borderRadius:s.radius,padding:"8px 16px",fontSize:"13px",fontWeight:600}}>{"\uD83D\uDCDE"} {d.telefon}</div>}<div style={{marginTop:"14px",display:"inline-flex",gap:"8px",flexWrap:"wrap"}}><div style={{padding:"8px 18px",borderRadius:s.btnRadius||s.radius,background:"#fff",color:s.primary,fontSize:"12px",fontWeight:700,cursor:"pointer"}}>Jetzt kontaktieren</div><div style={{padding:"8px 18px",borderRadius:s.btnRadius||s.radius,background:"rgba(255,255,255,0.15)",color:"#fff",fontSize:"12px",fontWeight:600,border:"1px solid rgba(255,255,255,0.3)"}}>Leistungen</div>{d.buchungslink&&<div style={{padding:"8px 18px",borderRadius:s.btnRadius||s.radius,background:s.primary,color:"#fff",fontSize:"12px",fontWeight:700,cursor:"pointer",border:"1px solid rgba(255,255,255,0.3)"}}>Termin buchen</div>}</div></div>{}</div></div><div style={{padding:`24px ${px} 20px`}}><div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"14px"}}><h2 style={{fontSize:compact?"15px":"18px",fontWeight:700,color:s.primary,margin:0}}>Unsere Leistungen</h2><div style={{flex:1,height:"1px",background:s.borderColor}}/></div>{allItems.length>0?(<div style={{display:"grid",gridTemplateColumns:compact?"1fr":"1fr 1fr",gap:"8px"}}>{allItems.map((l,i)=>(<div key={i} style={{background:s.cardBg,border:s.cardBorder!==false?`1px solid ${s.borderColor}`:"none",borderRadius:s.radius,padding:"11px 13px",display:"flex",alignItems:"flex-start",gap:"10px",boxShadow:s.cardShadow?s.shadow:"none",fontSize:"12px"}}><div style={{width:"20px",height:"20px",borderRadius:s.radius,background:s.accentSoft,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,fontSize:"11px",color:s.accent,fontWeight:700}}>{String(i+1).padStart(2,"0")}</div><span style={{fontWeight:500}}>{l}</span></div>))}</div>):(<div style={{background:s.cardBg,border:`2px dashed ${s.borderColor}`,borderRadius:s.radiusLg,padding:"24px",textAlign:"center",color:s.textLight,fontSize:"12px"}}>Ihre Leistungen erscheinen hier</div>)}</div>{d.fotos&&<div style={{padding:`0 ${px} 12px`}}><div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"10px"}}><h2 style={{fontSize:compact?"13px":"16px",fontWeight:700,color:s.primary,margin:0}}>Ihre Fotos</h2><div style={{flex:1,height:"1px",background:s.borderColor}}/></div><div style={{display:"grid",gridTemplateColumns:compact?"1fr 1fr":"repeat(5,1fr)",gap:"6px"}}>{[1,2,3,4,5].map(i=><div key={i} style={{aspectRatio:"1",background:`linear-gradient(135deg,${s.accentSoft},${s.borderColor})`,borderRadius:s.radius,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:3,border:`1px dashed ${s.borderColor}`}}><span style={{fontSize:compact?"1rem":"1.1rem"}}>📷</span><span style={{fontSize:"11px",color:s.textLight,fontWeight:600,textTransform:"uppercase",letterSpacing:".05em"}}>Foto {i}</span></div>)}</div></div>}<div style={{padding:`0 ${px} 24px`}}><div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"14px"}}><h2 style={{fontSize:compact?"15px":"18px",fontWeight:700,color:s.primary,margin:0}}>Über uns</h2><div style={{flex:1,height:"1px",background:s.borderColor}}/></div><div style={{background:s.cardBg,borderRadius:s.radiusLg,padding:"18px 20px",boxShadow:s.shadow,borderLeft:`3px solid ${s.accent}`}}><p style={{margin:0,color:s.textMuted,fontSize:"12px",lineHeight:1.7}}>{d.firmenname?`Dieser Text wird individuell für ${d.firmenname} generiert.`:"Hier entsteht Ihr individueller Text."}</p><div style={{marginTop:"10px",display:"inline-block",padding:"3px 9px",borderRadius:s.badgeRadius||"20px",background:s.badgeBg,color:s.badgeText,fontSize:"11px",fontWeight:600}}>Wird nach Bestellung generiert</div></div></div>{hasContact&&(<div style={{margin:`0 ${px} 24px`,padding:"20px",background:s.cardBg,borderRadius:s.radiusLg,boxShadow:s.shadow,border:`1px solid ${s.borderColor}`}}><h2 style={{fontSize:compact?"15px":"18px",fontWeight:700,color:s.primary,margin:"0 0 14px"}}>Kontakt</h2><div style={{display:"grid",gridTemplateColumns:compact?"1fr":"1fr 1fr",gap:"8px"}}>{[{icon:"\uD83D\uDCCD",label:"Adresse",value:adressFull},{icon:"\uD83D\uDCDE",label:"Telefon",value:d.telefon},{icon:"\u2709\uFE0F",label:"E-Mail",value:d.email},{icon:"\uD83D\uDD50",label:"Öffnungszeiten",value:zeit}].filter(x=>x.value).map((x,i)=>(<div key={i} style={{padding:"10px 12px",borderRadius:s.radius,background:s.accentSoft,fontSize:"11px"}}><div style={{fontSize:"11px",color:s.textMuted,textTransform:"uppercase",letterSpacing:"0.05em",fontWeight:600,marginBottom:"3px"}}>{x.icon} {x.label}</div><div style={{fontWeight:500,whiteSpace:"pre-line",lineHeight:1.5}}>{x.value}</div></div>))}</div>
{(d.facebook||d.instagram||d.linkedin||d.tiktok)&&<div style={{marginTop:"12px",display:"flex",gap:"8px",flexWrap:"wrap"}}>{d.facebook&&<div style={{padding:"6px 12px",borderRadius:s.btnRadius||s.radius,background:s.accentSoft,fontSize:"11px",fontWeight:600,color:s.accent}}>Facebook</div>}{d.instagram&&<div style={{padding:"6px 12px",borderRadius:s.btnRadius||s.radius,background:s.accentSoft,fontSize:"11px",fontWeight:600,color:s.accent}}>Instagram</div>}{d.linkedin&&<div style={{padding:"6px 12px",borderRadius:s.btnRadius||s.radius,background:s.accentSoft,fontSize:"11px",fontWeight:600,color:s.accent}}>LinkedIn</div>}{d.tiktok&&<div style={{padding:"6px 12px",borderRadius:s.btnRadius||s.radius,background:s.accentSoft,fontSize:"11px",fontWeight:600,color:s.accent}}>TikTok</div>}</div>}
</div>)}
{d.buchungslink&&<div style={{margin:`0 ${px} 24px`,padding:"20px",background:s.accent,borderRadius:s.radiusLg,textAlign:"center"}}><div style={{fontSize:compact?"13px":"15px",fontWeight:700,color:"#fff",marginBottom:"8px"}}>Termin online buchen</div><div style={{padding:"10px 24px",borderRadius:s.btnRadius||s.radius,background:"#fff",color:s.accent,fontSize:"13px",fontWeight:700,display:"inline-block",cursor:"pointer"}}>Jetzt Termin buchen</div></div>}
{d.preislisteUrl&&<div style={{margin:`0 ${px} 24px`,padding:"14px 20px",background:s.cardBg,borderRadius:s.radiusLg,border:`1px solid ${s.borderColor}`,display:"flex",alignItems:"center",justifyContent:"space-between"}}><div><div style={{fontSize:"13px",fontWeight:700,color:s.primary}}>Preisliste</div><div style={{fontSize:"11px",color:s.textMuted}}>Als PDF herunterladen</div></div><div style={{padding:"8px 16px",borderRadius:s.btnRadius||s.radius,background:s.primary,color:"#fff",fontSize:"11px",fontWeight:700,cursor:"pointer"}}>Ansehen</div></div>}
<div style={{background:s.primary,color:"#fff",padding:`20px ${px}`,fontSize:"12px"}}><div style={{display:"flex",justifyContent:"space-between",marginBottom:"12px"}}><div><div style={{fontWeight:700,fontSize:"13px",marginBottom:"3px"}}>{d.firmenname||"Firmenname"}</div><div style={{opacity:0.7}}>{adressFull}</div></div><div style={{textAlign:"right",opacity:0.7}}>{d.telefon&&<div>{d.telefon}</div>}{d.email&&<div>{d.email}</div>}</div></div>{(d.facebook||d.instagram||d.linkedin||d.tiktok)&&<div style={{display:"flex",gap:"12px",marginBottom:"12px",paddingBottom:"10px",borderBottom:"1px solid rgba(255,255,255,0.15)"}}>{d.facebook&&<span style={{opacity:.7,fontSize:"11px"}}>Facebook</span>}{d.instagram&&<span style={{opacity:.7,fontSize:"11px"}}>Instagram</span>}{d.linkedin&&<span style={{opacity:.7,fontSize:"11px"}}>LinkedIn</span>}{d.tiktok&&<span style={{opacity:.7,fontSize:"11px"}}>TikTok</span>}</div>}<div style={{borderTop:(d.facebook||d.instagram||d.linkedin||d.tiktok)?"none":"1px solid rgba(255,255,255,0.15)",paddingTop:(d.facebook||d.instagram||d.linkedin||d.tiktok)?"0":"10px",opacity:0.6,fontSize:"11px"}}>{(d.unternehmensform||d.firmenbuchnummer||d.uid)&&<div style={{marginBottom:5,lineHeight:1.6,opacity:.8}}>{d.unternehmensform&&<span>{d.unternehmensform} &nbsp;</span>}{d.uid&&<span>UID: {d.uid} &nbsp;</span>}{d.firmenbuchnummer&&<span>FN: {d.firmenbuchnummer} &nbsp;</span>}{d.firmenbuchgericht&&<span>{d.firmenbuchgericht} &nbsp;</span>}{d.gisazahl&&<span>GISA: {d.gisazahl}</span>}</div>}<div style={{display:"flex",justifyContent:"space-between"}}><span>Impressum | Datenschutz</span><span>SiteReady.at</span></div></div></div></div>)}
      ...
      {tab==="medien"&&(<div style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        {(()=>{const url=assetUrls["hero"];const busy=uploading["hero"];return(
          <div style={{background:"#fff",borderRadius:T.r,padding:"20px 24px",border:`1px solid ${T.bg3}`,boxShadow:T.sh1}}>
            ...
            <div style={{fontSize:".78rem",color:T.textMuted,marginTop:8}}>Empfohlen: JPG, mind. 1920 &times; 1080 px.</div>
          </div>
        );})()}
        {/* Leistungen-Fotos */}
