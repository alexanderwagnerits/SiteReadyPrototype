        ...
        {!loading&&tab==="arch-flows"&&(()=>{
          ...
          return(<div>
            ...
            <div style={{background:T.bg,borderRadius:T.rSm,padding:"16px 18px",border:`1px solid ${T.bg3}`,marginBottom:16}}>
              ...
              {fphase("Phase 3b – Portal Onboarding","#0891b2",<>{fnode("🏠","Portal","Onboarding nach Kauf","#0891b2")}{farrow}{fnode("📸","Fotos hochladen","Logo · Hero · Bilder","#0891b2",true)}{farrow}{fnode("🚀","Website erstellen","Klick → start-build.js","#0891b2")}</>)}
              {fphase("Phase 4 – Generierung","#8b5cf6",<>{fnode("⚙️","In Arbeit","status: in_arbeit","#8b5cf6")}{farrow}{fnode("🤖","Claude Sonnet","claude-sonnet-4-6","#8b5cf6")}{farrow}{fnode("🔧","Post-Processing","Nav · Footer · Meta · Schema.org","#8b5cf6")}{farrow}{fnode("🌍","Live","status: live · ~30-60 Sek.","#8b5cf6")}</>)}
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
              <div style={{background:T.bg,borderRadius:T.rSm,padding:"16px 18px",border:`1px solid ${T.bg3}`}}>
                ...
                {fphase("Verarbeitung","#f97316",<>{fnode("🔐","Signatur","HMAC-SHA256 · 5 Min.","#f97316")}{farrow}{fnode("💾","status: paid","Supabase PATCH","#2563eb")}</>)}
              </div>
              <div style={{background:T.bg,borderRadius:T.rSm,padding:"16px 18px",border:`1px solid ${T.bg3}`}}>
                {ftitle("🤖","Website-Generierung")}
                {fphase("Trigger","#0891b2",<>{fnode("🏠","Portal","Kunde klickt Erstellen","#0891b2")}{farrow}{fnode("🚀","start-build.js","status: in_arbeit","#0891b2")}{farrow}{fnode("⚙️","ctx.waitUntil","generate-website im HG","#f97316")}</>)}
