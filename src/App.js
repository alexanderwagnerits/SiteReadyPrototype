...
const STYLES_MAP={
  klassisch:{label:"Klassisch",desc:"Seriös, vertrauenswürdig, zeitlos",primary:"#0f2b5b",accent:"#0d9488",accentSoft:"rgba(13,148,136,0.07)",bg:"#f8fafc",cardBg:"#fff",text:"#0f172a",textMuted:"#64748b",textLight:"#94a3b8",borderColor:"#e2e8f0",font:"'Inter',system-ui,sans-serif",radius:"4px",radiusLg:"6px",heroGradient:"linear-gradient(160deg,#0f2b5b 0%,#1e3a6e 50%,#164e63 100%)",heroOverlay:"radial-gradient(circle at 70% 20%,rgba(255,255,255,0.06) 0%,transparent 60%)",shadow:"none",badgeBg:"#ccfbf1",badgeText:"#115e59",btnRadius:"4px",cardBorder:true,cardShadow:false,badgeRadius:"4px",sectionDivider:true,spacing:"compact"},
