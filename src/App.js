...
const STYLES_MAP={
  ...
  modern:{label:"Modern",desc:"Frisch, freundlich, mit Akzenten",primary:"#1e3a5f",accent:"#6366f1",accentSoft:"rgba(99,102,241,0.07)",bg:"#fafafa",cardBg:"#fff",text:"#111111",textMuted:"#6b7280",textLight:"#9ca3af",borderColor:"#f0f0f0",font:"'DM Sans',system-ui,sans-serif",radius:"12px",radiusLg:"16px",heroGradient:"linear-gradient(135deg,#1e3a5f 0%,#2d4a7c 50%,#6366f1 100%)",heroOverlay:"radial-gradient(ellipse at 80% 30%,rgba(99,102,241,0.2) 0%,transparent 50%)",shadow:"0 2px 8px rgba(0,0,0,0.06)",badgeBg:"#eef2ff",badgeText:"#4f46e5",btnRadius:"100px",cardBorder:false,cardShadow:true,badgeRadius:"100px",sectionDivider:false,spacing:"airy"},
