...
const BRANCHEN = [
  ...
  { value:"installateur",    label:"Installateur / Heizung / Sanitär", leistungen:["Heizungsinstallation & Wartung","Sanitärinstallationen","Rohrreinigung","Badsanierung","Wärmepumpen","Notdienst 24/7"],stil:"professional",features:FT_HANDWERK },
  ...
  { value:"tischler",        label:"Tischlerei",                        leistungen:["Möbel nach Maß","Küchenbau","Innenausbau","Fenster & Türen","Reparaturen","Restaurierung"],stil:"traditional",features:FT_HANDWERK },
  ...
  { value:"schlosser",       label:"Schlosserei / Metallbau",           leistungen:["Stahl- & Metallbau","Geländer & Zäune","Tore & Türen","Schweißarbeiten","Aufsperrdienst","Sonderanfertigungen"],stil:"professional",features:FT_HANDWERK },
  { value:"dachdecker",      label:"Dachdecker / Spengler",             leistungen:["Dachsanierung","Dachdämmung","Flachdach","Dachrinnen & Spenglerarbeiten","Dachfenster","Notdienst"],stil:"traditional",features:FT_HANDWERK },
  { value:"zimmerei",        label:"Zimmerei",                          leistungen:["Dachstühle & Holzbau","Carports & Terrassen","Aufstockungen","Holzfassaden","Sanierung & Altholz","Sonderanfertigungen"],stil:"traditional",features:FT_HANDWERK },
  { value:"maurer",          label:"Maurer / Baumeister",               leistungen:["Rohbau & Mauerwerk","Zu- & Umbauten","Sanierung & Renovierung","Fassadenarbeiten","Estricharbeiten","Abbrucharbeiten"],stil:"professional",features:FT_HANDWERK },
  ...
  { value:"klima",           label:"Klimatechnik / Lüftung",           leistungen:["Klimaanlagen Installation","Lüftungsanlagen","Wartung & Service","Wärmepumpen","Kühltechnik","Notdienst"],stil:"professional",features:FT_HANDWERK },
  ...
  { value:"kfz",             label:"KFZ-Werkstatt / Mechaniker",       leistungen:["KFZ-Service & Inspektion","Reparaturen","Pickerl (§57a)","Reifenservice","Klimaanlagen-Service","Lackierung & Karosserie"],stil:"professional",features:FT_HANDWERK },
  { value:"aufsperrdienst",  label:"Aufsperrdienst / Schlüsseldienst", leistungen:["Türöffnung","Schlossaustausch","Schließanlagen","Sicherheitsberatung","Tresoröffnung","Notdienst 24/7"],stil:"professional",features:FT_HANDWERK },
  { value:"hafner",          label:"Hafner / Ofenbau",                  leistungen:["Kachelofenbau","Kaminbau","Ofensanierung","Fliesenarbeiten","Ofenplanung & Beratung","Wartung & Reinigung"],stil:"traditional",features:FT_HANDWERK },
  ...
  { value:"tattoo",          label:"Tattoo & Piercing",                 leistungen:["Custom Tattoos","Cover-ups & Korrekturen","Piercing","Beratung & Design","Pflege & Nachsorge","Laser-Entfernung"],stil:"professional",features:FT_KOSMETIK },
  { value:"fusspflege",      label:"Fußpflege",                         leistungen:["Medizinische Fußpflege","Nagelpflege & Korrektur","Hornhautentfernung","Fußpeeling & Entspannungsbad","Diabetische Fußpflege","Beratung"],stil:"professional",features:FT_KOSMETIK },
  ...
  // Gastronomie
  { value:"restaurant",      label:"Restaurant / Gasthaus",             leistungen:["Speisekarte","Tagesmenü","Catering","Reservierung","Veranstaltungen","Lieferservice"],stil:"traditional",features:FT_GASTRO },
  ...
  { value:"bar",             label:"Bar / Lounge",                      leistungen:["Cocktails & Drinks","Events & Partys","DJ & Live-Musik","Private Feiern","Afterwork","Catering"],stil:"professional",features:FT_GASTRO },
  { value:"heuriger",        label:"Heuriger / Buschenschank",          leistungen:["Eigenbauweine","Kalte Jause","Saisonale Schmankerl","Gartenbereich","Weinverkostung","Veranstaltungen"],stil:"traditional",features:FT_GASTRO },
  ...
  { value:"catering",        label:"Catering / Partyservice",           leistungen:["Firmenevents","Hochzeiten","Buffets","Menü-Planung","Getränkeservice","Dekoration"],stil:"professional",features:FT_GASTRO },
  // Gesundheit
  { value:"physiotherapie",  label:"Physiotherapie",                    leistungen:["Manuelle Therapie","Bewegungstherapie","Sportphysiotherapie","Lymphdrainage","Elektrotherapie","Hausbesuche"],stil:"professional",features:FT_GESUNDHEIT },
  { value:"arzt",            label:"Arztpraxis / Ordination",           leistungen:["Allgemeinmedizin","Vorsorgeuntersuchung","Gesundenuntersuchung","Impfungen","Hausbesuche","Akutversorgung"],stil:"professional",features:FT_GESUNDHEIT },
  { value:"zahnarzt",        label:"Zahnarztpraxis",                    leistungen:["Zahnreinigung","Füllungen","Zahnersatz","Implantate","Kieferorthopädie","Ästhetische Zahnmedizin"],stil:"professional",features:FT_GESUNDHEIT },
  { value:"tierarzt",        label:"Tierarztpraxis",                    leistungen:["Vorsorge & Impfungen","Chirurgie","Zahnmedizin","Notfallversorgung","Hausbesuche","Ernährungsberatung"],stil:"professional",features:FT_GESUNDHEIT },
  { value:"apotheke",        label:"Apotheke",                          leistungen:["Rezepteinlösung","Beratung","Naturheilmittel","Kosmetik","Vorbestellung","Lieferservice"],stil:"professional",features:FT_GESUNDHEIT },
  ...
  { value:"psychotherapie",  label:"Psychotherapie",                    leistungen:["Einzeltherapie","Paartherapie","Kinder- & Jugendtherapie","Krisenintervention","Online-Therapie","Erstgespräch"],stil:"professional",features:FT_GESUNDHEIT },
  { value:"ergotherapie",    label:"Ergotherapie",                      leistungen:["Handtherapie","Kinder-Ergotherapie","Neurologische Therapie","Arbeitsplatzberatung","Hilfsmittelberatung","Hausbesuche"],stil:"professional",features:FT_GESUNDHEIT },
  { value:"logopaedie",      label:"Logopädie",                         leistungen:["Sprachtherapie","Stimmtherapie","Schlucktherapie","Kinder-Sprachförderung","Stotterbehandlung","Hausbesuche"],stil:"professional",features:FT_GESUNDHEIT },
  ...
  // Dienstleistungen
  { value:"steuerberater",   label:"Steuerberater / Buchhaltung",       leistungen:["Buchhaltung","Jahresabschluss","Steuererklärung","Lohnverrechnung","Gründungsberatung","Unternehmensberatung"],stil:"professional",features:FT_DIENSTLEISTUNG },
  { value:"rechtsanwalt",    label:"Rechtsanwalt / Kanzlei",            leistungen:["Vertragsrecht","Arbeitsrecht","Familienrecht","Mietrecht","Strafrecht","Erstberatung"],stil:"professional",features:FT_DIENSTLEISTUNG },
  { value:"versicherung",    label:"Versicherungsmakler",               leistungen:["Versicherungsvergleich","Beratung","Schadensabwicklung","Vorsorge","Firmenversicherung","Erstgespräch"],stil:"professional",features:FT_DIENSTLEISTUNG },
  { value:"immobilien",      label:"Immobilienmakler",                  leistungen:["Verkauf","Vermietung","Bewertung","Beratung","Besichtigungen","Verwaltung"],stil:"professional",features:FT_DIENSTLEISTUNG },
  { value:"hausverwaltung",  label:"Hausverwaltung",                    leistungen:["Objektverwaltung","Betriebskostenabrechnung","Eigentümervertretung","Mieterverwaltung","Instandhaltung","Sanierungsbetreuung"],stil:"professional",features:FT_DIENSTLEISTUNG },
  ...
  // Bildung & Training
  { value:"fahrschule",      label:"Fahrschule",                        leistungen:["Führerschein B","Führerschein A","Auffrischungskurs","Erste-Hilfe-Kurs","Theoriekurs","Intensivkurs"],stil:"professional",features:FT_BILDUNG },
  ...
  // Sonstige
  { value:"sonstige",        label:"Anderer Beruf (nicht in der Liste)", leistungen:[],stil:"professional",features:[] },
];
...
<div style={{marginTop:8,padding:"12px 14px",background:T.accentLight,borderRadius:T.rSm,border:`1px solid rgba(143,163,184,.15)`}}><div style={{fontSize:".78rem",color:T.accent,lineHeight:1.65}}>Diese Angaben werden automatisch in Ihr Impressum eingebaut (ECG-konform).<br/>Unterstützte Rechtsformen: e.U., Einzelunternehmen, GmbH, OG, KG, AG, Verein, GesbR. Bei anderen Rechtsformen bitte vorab Kontakt aufnehmen.</div></div><label style={{display:"flex",alignItems:"flex-start",gap:10,cursor:"pointer",padding:"14px 16px",background:T.bg,borderRadius:T.rSm,border:`1px solid ${impressumConfirm?T.accent+"44":T.bg3}`,marginBottom:16,marginTop:16}}><input type="checkbox" checked={impressumConfirm} onChange={e=>setImpressumConfirm(e.target.checked)} style={{marginTop:2,accentColor:T.accent,width:18,height:18,flexShrink:0,cursor:"pointer"}}/><span style={{fontSize:".82rem",color:T.textSub,lineHeight:1.6}}>Ich bestätige, dass die angegebenen Unternehmensdaten korrekt sind. Das Impressum wird auf Basis dieser Angaben erstellt.</span></label></>);})()}</>,<><p style={{fontSize:".88rem",color:T.textSub,margin:"0 0 6px",lineHeight:1.6}}>Basierend auf Ihrer Branche empfehlen wir:</p><p style={{fontSize:"1rem",fontWeight:700,color:T.dark,margin:"0 0 16px"}}>{STYLES_MAP[data.stil]?.label||"Professionell"}</p><StylePicker value={data.stil} onChange={up("stil")}/><div style={{marginTop:20,padding:"14px 16px",background:T.accentLight,borderRadius:T.rSm,border:`1px solid rgba(143,163,184,.15)`}}><div style={{fontSize:".78rem",fontWeight:700,color:T.accent,marginBottom:6}}>Nach dem Kauf – Self-Service-Portal</div><div style={{fontSize:".82rem",color:T.textSub,lineHeight:1.7}}>Logo hochladen &middot; Eigene Fotos hochladen &middot; Preisliste hochladen &middot; Custom Domain verbinden – alles selbst, jederzeit.</div></div></>];
  ...
  const formPanel=(<div style={{display:"flex",flexDirection:"column",background:T.bg,borderRight:isMobile?"none":`1px solid ${T.bg3}`,height:isMobile?"100dvh":"100%",overflowY:"hidden",fontFamily:T.font}}>
    ...
    <div style={{padding:"16px 24px",borderTop:`1px solid ${T.bg3}`,display:"flex",justifyContent:showImport?"flex-end":"space-between",background:"rgba(255,255,255,.92)",backdropFilter:"blur(8px)",WebkitBackdropFilter:"blur(8px)",boxShadow:"0 -2px 12px rgba(0,0,0,.04)"}}>
      {showImport?(<button onClick={()=>{setShowImport(false);}} style={{padding:"12px 20px",border:`1.5px solid ${T.bg3}`,borderRadius:10,background:"transparent",color:T.textSub,cursor:"pointer",fontSize:".85rem",fontWeight:600,fontFamily:T.font}}>Ohne Import starten</button>):(<>{step>0?<button onClick={()=>go(step-1)} style={{padding:"12px 20px",border:`1.5px solid ${T.bg3}`,borderRadius:10,background:"transparent",color:T.textSub,cursor:"pointer",fontSize:".85rem",fontWeight:600,fontFamily:T.font}}>{"\u2190"} Zurück</button>:<div/>}{step<STEPS.length-1?<button onClick={()=>go(step+1)} disabled={!stepValid[step]} style={{padding:"12px 24px",border:"none",borderRadius:10,background:stepValid[step]?T.dark:"#cbd5e1",color:"#fff",cursor:stepValid[step]?"pointer":"not-allowed",fontSize:".85rem",fontWeight:700,fontFamily:T.font,boxShadow:stepValid[step]?"0 2px 12px rgba(0,0,0,.12)":"none",transition:"background .2s"}}>Weiter &rarr;</button>:<button onClick={onComplete} disabled={!stepValid.every(v=>v)} style={{padding:"12px 24px",border:"none",borderRadius:10,background:stepValid.every(v=>v)?T.dark:"#cbd5e1",color:"#fff",cursor:stepValid.every(v=>v)?"pointer":"not-allowed",fontSize:".85rem",fontWeight:700,fontFamily:T.font,boxShadow:stepValid.every(v=>v)?"0 2px 12px rgba(0,0,0,.12)":"none",transition:"background .2s"}}>Website erstellen &rarr;</button>}</>)}
    </div>
  </div>);
...
const done=checks.filter(c=>c.done).length;if(done===checks.length)return null;return(<div style={{background:"#fff",borderRadius:T.r,padding:"0",border:`1px solid ${T.bg3}`,boxShadow:T.sh2,overflow:"hidden"}}><div style={{height:3,background:T.bg3}}><div style={{height:"100%",background:T.accent,borderRadius:"0 2px 2px 0",width:`${(done/checks.length)*100}%`,transition:"width .4s ease"}}/></div><div style={{padding:"18px 24px"}}><div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:12}}><div style={{fontSize:".75rem",fontWeight:700,color:T.textMuted,textTransform:"uppercase",letterSpacing:".1em"}}>Erste Schritte</div><div style={{fontSize:".75rem",color:T.textSub,fontWeight:600}}>{done}/{checks.length}</div></div><div style={{display:"flex",flexDirection:"column",gap:6}}>{checks.map((c,i)=><div key={i} onClick={c.tab&&!c.done?()=>setTab(c.tab):undefined} style={{display:"flex",alignItems:"center",gap:10,padding:"5px 0",cursor:c.tab&&!c.done?"pointer":"default"}}><div style={{width:18,height:18,borderRadius:"50%",background:c.done?"#16a34a":"#e2e8f0",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",fontSize:".65rem",fontWeight:800,flexShrink:0}}>{c.done?"\u2713":""}</div><span style={{fontSize:".875rem",color:c.done?T.textMuted:T.dark,flex:1}}>{c.label}</span>{c.tab&&!c.done&&<span style={{fontSize:".75rem",color:T.accent,fontWeight:700}}>\u2192</span>}</div>)}</div></div></div>);})()}
        ...
        <div style={{background:"#fff",borderRadius:T.r,padding:"24px 28px",border:`1px solid ${T.bg3}`,boxShadow:T.sh1}}>
          ...
          {editSection==="leistungen"?(<>
            ...
            {(()=>{const ft=getBrancheFeatures(order?.branche);return<>{ft.includes("notdienst")&&<Toggle label="24h Notdienst" checked={!!order.notdienst} onChange={upOrder("notdienst")} desc="Wird prominent angezeigt"/>}{ft.includes("meisterbetrieb")&&<Toggle label="Meisterbetrieb" checked={!!order.meisterbetrieb} onChange={upOrder("meisterbetrieb")} desc="Meisterbetrieb-Badge"/>}{ft.includes("kostenvoranschlag")&&<Toggle label="Kostenloser Kostenvoranschlag" checked={!!order.kostenvoranschlag} onChange={upOrder("kostenvoranschlag")} desc="Vertrauens-Badge"/>}{ft.includes("foerderungsberatung")&&<Toggle label="Förderungsberatung" checked={!!order.foerderungsberatung} onChange={upOrder("foerderungsberatung")} desc="Förderungsberatung"/>}{ft.includes("buchungslink")&&<Field label="Online-Buchungslink" value={order.buchungslink||""} onChange={upOrder("buchungslink")} placeholder="https://booksy.com/..." hint="Optional"/>}{ft.includes("hausbesuche")&&<Toggle label="Hausbesuche" checked={!!order.hausbesuche} onChange={upOrder("hausbesuche")} desc="Ich komme auch zu Ihnen"/>}{ft.includes("terminvereinbarung")&&<Toggle label="Nur nach Terminvereinbarung" checked={!!order.terminvereinbarung} onChange={upOrder("terminvereinbarung")} desc="Kein Walk-in"/>}{ft.includes("lieferservice")&&<Toggle label="Lieferservice" checked={!!order.lieferservice} onChange={upOrder("lieferservice")} desc="Lieferung"/>}{ft.includes("barrierefrei")&&<Toggle label="Barrierefrei" checked={!!order.barrierefrei} onChange={upOrder("barrierefrei")} desc="Rollstuhlgerecht"/>}{ft.includes("parkplaetze")&&<Toggle label="Parkplätze" checked={!!order.parkplaetze} onChange={upOrder("parkplaetze")} desc="Kundenparkplätze"/>}{ft.includes("kassenvertrag")&&<Dropdown label="Kassenvertrag" value={order.kassenvertrag||""} onChange={upOrder("kassenvertrag")} options={[{value:"alle_kassen",label:"Alle Kassen"},{value:"oegk",label:"ÖGK"},{value:"bvaeb",label:"BVAEB"},{value:"svs",label:"SVS"},{value:"wahlarzt",label:"Wahlarzt / Wahltherapeut"},{value:"privat",label:"Nur Privat"}]} placeholder="Kassenvertrag wählen"/>}{ft.includes("erstgespraech_gratis")&&<Toggle label="Erstgespräch gratis" checked={!!order.erstgespraech_gratis} onChange={upOrder("erstgespraech_gratis")} desc="Kostenloses Erstgespräch"/>}{ft.includes("online_beratung")&&<Toggle label="Online-Beratung" checked={!!order.online_beratung} onChange={upOrder("online_beratung")} desc="Video-Call"/>}{ft.includes("ratenzahlung")&&<Toggle label="Ratenzahlung" checked={!!order.ratenzahlung} onChange={upOrder("ratenzahlung")} desc="Ratenzahlung"/>}</>;})()}
          </>):(<>
