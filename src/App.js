...
const BRANCHEN = [
  ...
  { value:"fliesenleger",    label:"Fliesenleger",                      leistungen:["Fliesenverlegung","Badsanierung","Natursteinarbeiten","Terrassenplatten","Abdichtungen","Reparaturen"],stil:"modern",features:["meisterbetrieb","kostenvoranschlag"] },
  { value:"schlosser",       label:"Schlosserei / Metallbau",           leistungen:["Stahl- & Metallbau","Geländer & Zäune","Tore & Türen","Schweißarbeiten","Reparaturen","Sonderanfertigungen"],stil:"professional",features:["meisterbetrieb","kostenvoranschlag"] },
  ...
  <section className="lp-sec sr-reveal" style={{padding:"96px 0 64px",background:T.bg}}>
    <W>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))",gap:12}}>
        {[{t:"Handwerk",items:["Elektriker","Installateur","Maler","Tischler","Fliesenleger","Schlosser","Dachdecker","Zimmerei","Maurer","Gärtner","Klima & Lüftung","Reinigung"]},{t:"Kosmetik & Pflege",items:["Kosmetikstudio","Friseursalon","Nagelstudio","Massage & Wellness","Tattoo & Piercing","Fußpflege","Permanent Make-up"]},{t:"Gastronomie",items:["Restaurant","Café / Bäckerei","Bar / Lounge","Imbiss / Foodtruck","Catering"]},{t:"Gesundheit",items:["Physiotherapie","Arztpraxis","Zahnarzt","Tierarzt","Apotheke","Optiker","Heilpraktiker"]},{t:"Dienstleistungen",items:["Steuerberater","Rechtsanwalt","Versicherung","Immobilien","Umzug & Transport","Eventplanung"]},{t:"Bildung & Training",items:["Fahrschule","Nachhilfe","Musikschule","Personal Trainer"]},].map(g=><div key={g.t} style={{background:"#fff",borderRadius:12,border:"1px solid rgba(0,0,0,.08)",padding:"20px 24px",boxShadow:T.sh1}}>
