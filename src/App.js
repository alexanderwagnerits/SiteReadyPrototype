...
const BRANCHEN = [
  // Handwerk
  { value:"elektro",         label:"Elektroinstallationen",            leistungen:["Elektroinstallationen","Störungsbehebung & Reparatur","Smart Home Systeme","Photovoltaik & Speicher","Beleuchtungstechnik","Notdienst 24/7"],stil:"professional",features:["notdienst","meisterbetrieb","kostenvoranschlag"] },
  { value:"installateur",    label:"Installateur / Heizung / Sanitär", leistungen:["Heizungsinstallation & Wartung","Sanitärinstallationen","Rohrreinigung","Badsanierung","Wärmepumpen","Notdienst 24/7"],stil:"professional",features:["notdienst","meisterbetrieb","kostenvoranschlag"] },
  { value:"maler",           label:"Malerei & Anstrich",                leistungen:["Innenmalerei","Fassadenanstrich","Tapezierarbeiten","Lackierarbeiten","Schimmelbehandlung","Farbberatung"],stil:"modern",features:["meisterbetrieb","kostenvoranschlag"] },
  { value:"tischler",        label:"Tischlerei",                        leistungen:["Möbel nach Maß","Küchenbau","Innenausbau","Fenster & Türen","Reparaturen","Restaurierung"],stil:"traditional",features:["meisterbetrieb","kostenvoranschlag"] },
  { value:"fliesenleger",    label:"Fliesenleger / Plattenleger",       leistungen:["Fliesenverlegung","Badsanierung","Natursteinarbeiten","Terrassenplatten","Abdichtungen","Reparaturen"],stil:"modern",features:["meisterbetrieb","kostenvoranschlag"] },
  { value:"schlosser",       label:"Schlosserei / Metallbau",           leistungen:["Stahl- & Metallbau","Geländer & Zäune","Tore & Türen","Schweißarbeiten","Aufsperrdienst","Sonderanfertigungen"],stil:"professional",features:["notdienst","meisterbetrieb","kostenvoranschlag"] },
  { value:"dachdecker",      label:"Dachdecker / Spengler",             leistungen:["Dachsanierung","Dachdämmung","Flachdach","Dachrinnen & Spenglerarbeiten","Dachfenster","Notdienst"],stil:"traditional",features:["notdienst","meisterbetrieb","kostenvoranschlag"] },
  { value:"zimmerei",        label:"Zimmerei",                          leistungen:["Dachstühle & Holzbau","Carports & Terrassen","Aufstockungen","Holzfassaden","Sanierung & Altholz","Sonderanfertigungen"],stil:"traditional",features:["meisterbetrieb","kostenvoranschlag"] },
  { value:"maurer",          label:"Maurer / Baumeister",               leistungen:["Rohbau & Mauerwerk","Zu- & Umbauten","Sanierung & Renovierung","Fassadenarbeiten","Estricharbeiten","Abbrucharbeiten"],stil:"professional",features:["meisterbetrieb","kostenvoranschlag"] },
  { value:"bodenleger",      label:"Bodenleger / Parkett",              leistungen:["Parkettverlegung","Laminat & Vinyl","Schleifen & Versiegeln","Teppichboden","Reparaturen","Bodenberatung"],stil:"modern",features:["meisterbetrieb","kostenvoranschlag"] },
  { value:"glaser",          label:"Glaser",                            leistungen:["Glasreparaturen","Isolierglas","Spiegel & Glasmöbel","Duschwände","Glasfassaden","Notdienst"],stil:"modern",features:["notdienst","meisterbetrieb","kostenvoranschlag"] },
  { value:"gaertner",        label:"Gärtner / Landschaftsbau",         leistungen:["Gartengestaltung","Pflasterarbeiten","Bepflanzung & Pflege","Bewässerungssysteme","Zaunbau","Baumschnitt & Pflege"],stil:"modern",features:["meisterbetrieb","kostenvoranschlag"] },
  ...
  { value:"reinigung",       label:"Reinigung / Gebäudeservice",       leistungen:["Gebäudereinigung","Fensterreinigung","Grundreinigung","Teppichreinigung","Fassadenreinigung","Winterdienst"],stil:"modern",features:["notdienst","kostenvoranschlag"] },
  { value:"kfz",             label:"KFZ-Werkstatt / Mechaniker",       leistungen:["KFZ-Service & Inspektion","Reparaturen","Pickerl (§57a)","Reifenservice","Klimaanlagen-Service","Lackierung & Karosserie"],stil:"professional",features:["notdienst","meisterbetrieb","kostenvoranschlag"] },
  { value:"aufsperrdienst",  label:"Aufsperrdienst / Schlüsseldienst", leistungen:["Türöffnung","Schlossaustausch","Schließanlagen","Sicherheitsberatung","Tresoröffnung","Notdienst 24/7"],stil:"professional",features:["notdienst","kostenvoranschlag"] },
  { value:"hafner",          label:"Hafner / Ofenbau",                  leistungen:["Kachelofenbau","Kaminbau","Ofensanierung","Fliesenarbeiten","Ofenplanung & Beratung","Wartung & Reinigung"],stil:"traditional",features:["meisterbetrieb","kostenvoranschlag"] },
  { value:"raumausstatter",  label:"Raumausstatter / Polsterer",        leistungen:["Polsterarbeiten","Vorhänge & Gardinen","Sonnenschutz","Bodenbeläge","Wandgestaltung","Raumplanung"],stil:"modern",features:["meisterbetrieb","kostenvoranschlag"] },
  ...
  { value:"nagel",           label:"Nagelstudio",                       leistungen:["Gel-Nägel & Shellac","Nagelverlängerung","Nail Art & Design","Nagelreparatur","Fußpflege & Nagellack","Beratung"],stil:"modern",features:["buchungslink","hausbesuche","terminvereinbarung"] },
  { value:"massage",         label:"Massage & Wellness",                leistungen:["Klassische Massage","Sportmassage","Entspannungsmassage","Hot-Stone-Massage","Triggerpunkt-Therapie","Lymphdrainage"],stil:"modern",features:["buchungslink","hausbesuche","terminvereinbarung"] },
  ...
  { value:"fusspflege",      label:"Fußpflege",                         leistungen:["Medizinische Fußpflege","Nagelpflege & Korrektur","Hornhautentfernung","Fußpeeling & Entspannungsbad","Diabetische Fußpflege","Beratung"],stil:"professional",features:["buchungslink","hausbesuche","terminvereinbarung"] },
  ...
  { value:"hundesalon",      label:"Hundesalon / Tierbetreuung",        leistungen:["Hundefrisur & Pflege","Baden & Föhnen","Krallenpflege","Tierbetreuung","Gassi-Service","Hundetraining"],stil:"modern",features:["buchungslink","hausbesuche","terminvereinbarung"] },
  // Gastronomie
  { value:"restaurant",      label:"Restaurant / Gasthaus",             leistungen:["Speisekarte","Tagesmenü","Catering","Reservierung","Veranstaltungen","Lieferservice"],stil:"traditional",features:["buchungslink","kostenvoranschlag"] },
  { value:"cafe",            label:"Café / Konditorei",                 leistungen:["Frühstück","Kuchen & Torten","Kaffeespezialitäten","Catering","Veranstaltungen","Take-away"],stil:"modern",features:["buchungslink"] },
  ...
  { value:"heuriger",        label:"Heuriger / Buschenschank",          leistungen:["Eigenbauweine","Kalte Jause","Saisonale Schmankerl","Gartenbereich","Weinverkostung","Veranstaltungen"],stil:"traditional",features:[] },
  ...
  // Gesundheit
  { value:"physiotherapie",  label:"Physiotherapie",                    leistungen:["Manuelle Therapie","Bewegungstherapie","Sportphysiotherapie","Lymphdrainage","Elektrotherapie","Hausbesuche"],stil:"professional",features:["buchungslink","hausbesuche","terminvereinbarung"] },
  ...
  { value:"psychotherapie",  label:"Psychotherapie",                    leistungen:["Einzeltherapie","Paartherapie","Kinder- & Jugendtherapie","Krisenintervention","Online-Therapie","Erstgespräch"],stil:"professional",features:["buchungslink","terminvereinbarung"] },
  { value:"ergotherapie",    label:"Ergotherapie",                      leistungen:["Handtherapie","Kinder-Ergotherapie","Neurologische Therapie","Arbeitsplatzberatung","Hilfsmittelberatung","Hausbesuche"],stil:"professional",features:["buchungslink","hausbesuche","terminvereinbarung"] },
  { value:"logopaedie",      label:"Logopädie",                         leistungen:["Sprachtherapie","Stimmtherapie","Schlucktherapie","Kinder-Sprachförderung","Stotterbehandlung","Hausbesuche"],stil:"professional",features:["buchungslink","hausbesuche","terminvereinbarung"] },
  { value:"energetiker",     label:"Energetiker / Humanenergetiker",    leistungen:["Energetische Körperarbeit","Meridianarbeit","Aromatherapie","Kinesiologie","Klangschalentherapie","Beratung"],stil:"modern",features:["buchungslink","hausbesuche","terminvereinbarung"] },
  // Dienstleistungen
  ...
  { value:"hausverwaltung",  label:"Hausverwaltung",                    leistungen:["Objektverwaltung","Betriebskostenabrechnung","Eigentümervertretung","Mieterverwaltung","Instandhaltung","Sanierungsbetreuung"],stil:"professional",features:["terminvereinbarung"] },
  ...
  { value:"yoga",            label:"Yoga / Pilates Studio",              leistungen:["Hatha Yoga","Vinyasa Yoga","Pilates","Meditation","Workshops","Online-Kurse"],stil:"modern",features:["buchungslink","terminvereinbarung"] },
  // Sonstige
      ...
      {tab==="website"&&(!order?<div style={{background:"#fff",borderRadius:T.r,padding:"28px 32px",border:`1px solid ${T.bg3}`,color:T.textMuted,fontSize:".9rem"}}>Bestellung wird geladen...</div>:<div style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        <div style={{background:"#fff",borderRadius:T.r,padding:"24px 28px",border:`1px solid ${T.bg3}`,boxShadow:T.sh1}}>
          ...
          {editSection==="leistungen"?(<>
            ...
            {(()=>{const ft=getBrancheFeatures(order?.branche);return<>{ft.includes("notdienst")&&<InfoRow label="24h Notdienst" value={order.notdienst?"Ja":"Nein"}/>}{ft.includes("meisterbetrieb")&&<InfoRow label="Meisterbetrieb" value={order.meisterbetrieb?"Ja":"Nein"}/>}{ft.includes("kostenvoranschlag")&&<InfoRow label="Kostenloser KV" value={order.kostenvoranschlag?"Ja":"Nein"}/>}{ft.includes("buchungslink")&&<InfoRow label="Buchungslink" value={order.buchungslink||"\u2014"}/>}{ft.includes("hausbesuche")&&<InfoRow label="Hausbesuche" value={order.hausbesuche?"Ja":"Nein"}/>}{ft.includes("terminvereinbarung")&&<InfoRow label="Nur mit Termin" value={order.terminvereinbarung?"Ja":"Nein"}/>}</>;})()}
          </>)}
        </div>
        {/* Website-Texte */}
        <div style={{background:"#fff",borderRadius:T.r,padding:"24px 28px",border:`1px solid ${T.bg3}`,boxShadow:T.sh1}}>
