...
const STYLES_MAP={
  klassisch:{label:"Klassisch",desc:"Seriös, vertrauenswürdig, zeitlos",primary:"#0f2b5b",accent:"#0f766e",accentSoft:"rgba(15,118,110,0.07)",bg:"#f8fafc",cardBg:"#fff",text:"#0f172a",textMuted:"#64748b",textLight:"#94a3b8",borderColor:"#e2e8f0",font:"'Inter',system-ui,sans-serif",radius:"4px",radiusLg:"6px",heroGradient:"linear-gradient(160deg,#0f2b5b 0%,#1e3a6e 50%,#134e4a 100%)",heroOverlay:"radial-gradient(circle at 70% 20%,rgba(255,255,255,0.06) 0%,transparent 60%)",shadow:"none",badgeBg:"#ccfbf1",badgeText:"#115e59",btnRadius:"4px",cardBorder:true,cardShadow:false,badgeRadius:"4px",sectionDivider:true,spacing:"compact"},
  modern:{label:"Modern",desc:"Dynamisch, frisch, mit Akzenten",primary:"#0f172a",accent:"#7c3aed",accentSoft:"rgba(124,58,237,0.07)",bg:"#fafafa",cardBg:"#fff",text:"#0f172a",textMuted:"#6b7280",textLight:"#9ca3af",borderColor:"#f0f0f0",font:"'Plus Jakarta Sans',system-ui,sans-serif",radius:"12px",radiusLg:"16px",heroGradient:"linear-gradient(135deg,#0f172a 0%,#1e1b4b 50%,#7c3aed 100%)",heroOverlay:"radial-gradient(ellipse at 80% 30%,rgba(124,58,237,0.2) 0%,transparent 50%)",shadow:"0 2px 8px rgba(0,0,0,0.06)",badgeBg:"#ede9fe",badgeText:"#6d28d9",btnRadius:"100px",cardBorder:false,cardShadow:true,badgeRadius:"100px",sectionDivider:false,spacing:"airy"},
  elegant:{label:"Elegant",desc:"Hochwertig, ruhig, Premium",primary:"#292524",accent:"#57534e",accentSoft:"rgba(87,83,78,0.06)",bg:"#fafaf9",cardBg:"#fff",text:"#1c1917",textMuted:"#78716c",textLight:"#a8a29e",borderColor:"#e7e5e4",font:"'Inter',system-ui,sans-serif",radius:"2px",radiusLg:"4px",heroGradient:"linear-gradient(160deg,#292524 0%,#44403c 50%,#57534e 100%)",heroOverlay:"none",shadow:"none",badgeBg:"#f5f5f4",badgeText:"#57534e",btnRadius:"2px",cardBorder:true,cardShadow:false,badgeRadius:"2px",sectionDivider:true,spacing:"airy"},
...
.pt-wiz-line.done{background:#4ade80}
...
.pt-wiz-num.done{background:#4ade80;color:#fff}
      ...
      {(tab==="website"||tab==="extras")&&page!=="overview"&&(!order?<div style={{background:"#fff",borderRadius:T.r,padding:"28px 32px",border:`1px solid ${T.bg3}`,color:T.textMuted,fontSize:".9rem"}}>Bestellung wird geladen...</div>:<>
        ...
        {page==="design"&&(()=>{
          ...
          const PALETTES=[
            ...
            {name:"Frisch & Modern",desc:"Indigo + Cyan",colors:{custom_color:"#312e81",custom_accent:"#0e7490",custom_bg:"#f8fafc",custom_text:"#0f172a",custom_text_muted:"#6b7280",custom_sep:"#e5e7eb"}},
            {name:"Elegant & Ruhig",desc:"Anthrazit + Taupe",colors:{custom_color:"#292524",custom_accent:"#57534e",custom_bg:"#fafaf9",custom_text:"#1c1917",custom_text_muted:"#78716c",custom_sep:"#e7e5e4"}},
            {name:"Vertrauen & Sicherheit",desc:"Blau + Grün",colors:{custom_color:"#1e3a5f",custom_accent:"#047857",custom_bg:"#f0fdf4",custom_text:"#1e293b",custom_text_muted:"#64748b",custom_sep:"#d1fae5"}},
